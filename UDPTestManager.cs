...
namespace PcarsUDP
{
    public class UDPTestManager : IDisposable
    {
        ...
        public UDPTestManager(UdpClient listen, IPEndPoint group)
        {
            //_listener = listen;
            //_groupEP = group;
            random = new Random();
        ...
        {
            GearNumGears = random.Next(6);
            Rpm = (ushort)random.Next(0, 255);
            Speed = random.Next(0, 255);
        ...
        public void ReadTelemetryData(Stream stream, BinaryReader binaryReader)
        {
            ...
            GearNumGears = binaryReader.ReadInt32();//binaryReader.ReadByte()
        ...
        public int GearNumGears
        {
            get
            {
                return Convert.ToInt32(_GearNumGears) - 96;
